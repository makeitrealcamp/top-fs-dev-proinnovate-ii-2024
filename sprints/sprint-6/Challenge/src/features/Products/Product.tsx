    ...
    <div>
      <div className="border border-[#e4e4e4] h-[300px] mb-4 relative overflow-hidden group transition cursor-pointer">
        ...
        <div className="absolute top-6 -right-11 group-hover:right-5 p-2 flex flex-col justify-center items-center gap-y-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
          <button onClick={() => console.log('add me to the cart')}>
            <div className="flex justify-center items-center text-black w-12 h-12 bg-teal-500">
      ...
      <div>
        ...
        <Link to={`/product/${id}`}>
          <h2 className="font-semibold mb-1 text-black">{title}</h2>
        </Link>
